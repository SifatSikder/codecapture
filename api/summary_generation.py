...
class TranscriptionAndSummaryGenerator:

    def __init__(self):
        pass

    def extract_audio(self, video_path, audio_output="audio.mp3"):
    ...
    def save_transcription_with_timestamps(self, segments, file_path):
    ...
    def create_transcription(self, video_path, transcription_file_path):
        audio_path = "extracted_audio.mp3"
        self.extract_audio(video_path, audio_path)
        segments = self.transcribe_audio_with_whisper(audio_path)
        self.save_transcription_with_timestamps(segments, transcription_file_path)
        if os.path.exists(audio_path):
            os.remove(audio_path)

    def create_summary(self, transcription_file_path, summary_file_path):
    ...
    def summarize(self, video_folder_path):
