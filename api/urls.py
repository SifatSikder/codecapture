...
from .views import generate_notes, generate_notes_again ,extract_source_code_again, transcribe_video,summarize_video,extract_source_code,extract_workflow,generate_all,check_api, transcribe_video_again
urlpatterns = [
